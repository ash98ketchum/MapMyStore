...
// interface** that now includes `label`.
// ------------------------------------------------------------
...
export const mockShelves: Shelf[] = [
  ...
  { id: 'shelf-3', label: '#3', type: 'aisle',    x: 100, y: 260, width: 120, height: 40, zone: 'grocery',     capacity: 50, products: [] },
  { id: 'shelf-4', label: '#4', type: 'endcap',   x: 300, y: 100, width:  80, height: 60, zone: 'snacks',      capacity: 30, products: [] },
  { id: 'shelf-5', label: '#5', type: 'island',   x: 450, y: 150, width: 100, height: 80, zone: 'electronics', capacity: 20, products: [] },
  { id: 'shelf-6', label: '#6', type: 'aisle',    x: 300, y: 220, width: 120, height: 40, zone: 'electronics', capacity: 40, products: [] },
  { id: 'shelf-7', label: '#7', type: 'aisle',    x: 100, y: 340, width: 120, height: 40, zone: 'health',      capacity: 45, products: [] },
  { id: 'shelf-8', label: '#8', type: 'aisle',    x: 300, y: 340, width: 120, height: 40, zone: 'health',      capacity: 45, products: [] },
];
